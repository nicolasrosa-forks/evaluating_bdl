...
snapshot_dir = "/workspace/evaluating_bdl/depthCompletion/training_logs/%s_M%d_eval_seq_virtual" % (model_id, M)

virtualkitti_path = "/root/data/virtualkitti"

batch_size = 4

restore_from = "/workspace/evaluating_bdl/depthCompletion/trained_models/%s/checkpoint_40000.pth" % model_id
