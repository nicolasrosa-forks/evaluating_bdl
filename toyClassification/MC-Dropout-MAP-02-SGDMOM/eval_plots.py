...
for M in M_values:
    for iter in range(6):
        ...
        network.load_state_dict(torch.load("/workspace/evaluating_bdl/toyClassification/training_logs/model_MC-Dropout-MAP-02-SGDMOM_1_M10_%d/checkpoints/model_MC-Dropout-MAP-02-SGDMOM_1_M10_epoch_300.pth" % iter))
