...
network = ToyNet("eval_MC-Dropout-MAP-02-SGD_1_M10_0", project_dir="/workspace/evaluating_bdl/toyClassification").cuda()
network.load_state_dict(torch.load("/workspace/evaluating_bdl/toyClassification/training_logs/model_MC-Dropout-MAP-02-SGD_1_M10_0/checkpoints/model_MC-Dropout-MAP-02-SGD_1_M10_epoch_300.pth"))
