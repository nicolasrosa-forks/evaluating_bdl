...
for i in range(M):
    ...
    network.load_state_dict(torch.load("/workspace/evaluating_bdl/toyClassification/training_logs/model_Ensemble-Adam_1_M1024_%d/checkpoints/model_Ensemble-Adam_1_M1024_epoch_150.pth" % i))
