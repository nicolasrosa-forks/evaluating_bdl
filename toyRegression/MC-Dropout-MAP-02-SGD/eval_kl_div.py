...
for M in M_values:
    ...
    for l in range(L):
        ...
        network.load_state_dict(torch.load("/workspace/evaluating_bdl/toyRegression/training_logs/model_MC-Dropout-MAP-02-SGD_1_M10_%d/checkpoints/model_MC-Dropout-MAP-02-SGD_1_M10_epoch_300.pth" % l))
