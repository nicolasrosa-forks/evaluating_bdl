...
network = ToyNet("eval_Deterministic", project_dir="/workspace/evaluating_bdl/toyRegression").cuda()
network.load_state_dict(torch.load("/workspace/evaluating_bdl/toyRegression/training_logs/model_Deterministic/checkpoints/model_Deterministic_epoch_150.pth"))
