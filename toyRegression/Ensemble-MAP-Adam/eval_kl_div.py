...
for M in M_values:
    ...
    for l in range(L):
        ...
        for i in range(M):
            ...
            network = ToyNet("eval_Ensemble-MAP-Adam_1_M1024", project_dir="/workspace/evaluating_bdl/toyRegression").cuda()
            network.load_state_dict(torch.load("/workspace/evaluating_bdl/toyRegression/training_logs/model_Ensemble-MAP-Adam_1_M1024_%d/checkpoints/model_Ensemble-MAP-Adam_1_M1024_epoch_150.pth" % (l*M + i)))
