...
for i in range(num_samples):
    ...
    network = ToyNet("eval_HMC", project_dir="/workspace/evaluating_bdl/toyRegression").cuda()
...
# with open("/workspace/evaluating_bdl/toyRegression/HMC/final_sigma_alea_values.pkl", "rb") as file: # (needed for python3)
#     final_sigma_alea_values = pickle.load(file) # (list of 1000 elements)
# with open("/workspace/evaluating_bdl/toyRegression/HMC/final_sigma_epi_values.pkl", "rb") as file: # (needed for python3)
