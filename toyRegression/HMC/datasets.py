...
#
# with open("/workspace/evaluating_bdl/toyRegression/x.pkl", "wb") as file:
#     pickle.dump(x, file)
# with open("/workspace/evaluating_bdl/toyRegression/y.pkl", "wb") as file:
#     pickle.dump(y, file)
# ################################################################################
...
class ToyDataset(torch.utils.data.Dataset):
    def __init__(self):
        ...
        plt.ylabel("y")
        plt.xlabel("x")
        plt.savefig("/workspace/evaluating_bdl/toyRegression/HMC/training_data.png")
        plt.close(1)
