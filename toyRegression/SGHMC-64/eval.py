...
for i in range(M):
    ...
    network = ToyNet("eval_SGHMC-64_1", project_dir="/workspace/evaluating_bdl/toyRegression").cuda()
    network.load_state_dict(torch.load("/workspace/evaluating_bdl/toyRegression/training_logs/model_SGHMC-64_1/checkpoints/model_SGHMC-64_1_epoch_%d.pth" % int(num_epochs - i*step_size)))
