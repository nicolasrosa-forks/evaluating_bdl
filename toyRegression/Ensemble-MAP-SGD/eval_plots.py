...
for M in M_values:
    for iter in range(6):
        ...
        for i in network_inds:
            ...
            network.load_state_dict(torch.load("/workspace/evaluating_bdl/toyRegression/training_logs/model_Ensemble-MAP-SGD_1_M1024_%d/checkpoints/model_Ensemble-MAP-SGD_1_M1024_epoch_150.pth" % i))
