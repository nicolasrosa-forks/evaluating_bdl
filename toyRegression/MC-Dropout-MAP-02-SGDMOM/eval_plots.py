...
for M in M_values:
    for iter in range(6):
        ...
        network = ToyNet("eval_MC-Dropout-MAP-02-SGDMOM_1_M10", project_dir="/workspace/evaluating_bdl/toyRegression").cuda()
        network.load_state_dict(torch.load("/workspace/evaluating_bdl/toyRegression/training_logs/model_MC-Dropout-MAP-02-SGDMOM_1_M10_%d/checkpoints/model_MC-Dropout-MAP-02-SGDMOM_1_M10_epoch_300.pth" % iter))
